...
SCRIPTS_DIR="${AGENT_ROOT}/deployment-root/${DEPLOYMENT_GROUP_ID}/${DEPLOYMENT_ID}/deployment-archive/deploy/hook-scripts"
COMMAND="${SCRIPTS_DIR}/${DEPLOYMENT_GROUP_NAME}/${LIFECYCLE_EVENT}.sh"
